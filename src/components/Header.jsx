        ...
        <div id="navbarCollapse" className="navbar-collapse">
          <div className="navbar-collapse d-flex justify-content-end" id="navbarSupportedContent" >
            ...
            <div className="dropstart">
              ...
              <ul className="dropdown-menu mt-5">
                <li><Link to="#" className="dropdown-item text-success disabled fw-bold fs-6">{name}</Link></li>
                <li>
                  <hr className="dropdown-divider" />
                </li>
                <li className='dropdown-item'><Link className="cssnav" to="/profile"><i
                  className="fa-solid fa-user m-2"></i> Profile</Link></li>
                <li  className='dropdown-item'><Link className="cssnav" to="/setting"><i
                  className="fa-solid fa-gear m-2"></i> Settings</Link></li>
                <li className='dropdown-item' onClick={() => dispatch(logout())}><Link className="cssnav" to="#" ><i
